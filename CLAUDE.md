...
- **Foundation Models and KeyboardKit API surfaces here were verified against source/docs, not written from memory.** Keep that standard — check before changing a call signature or adding an enum case.
